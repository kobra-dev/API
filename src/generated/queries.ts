...
/** A template to use for sending emails [See type definition](https://app.contentful.com/spaces/toxox86i0ilk/content_types/emailTemplate) */
...
/** A template to use for sending emails [See type definition](https://app.contentful.com/spaces/toxox86i0ilk/content_types/emailTemplate) */
export type EmailTemplateIdArgs = {
  locale?: Maybe<Scalars['String']>;
};


/** A template to use for sending emails [See type definition](https://app.contentful.com/spaces/toxox86i0ilk/content_types/emailTemplate) */
export type EmailTemplateFromArgs = {
  locale?: Maybe<Scalars['String']>;
};


/** A template to use for sending emails [See type definition](https://app.contentful.com/spaces/toxox86i0ilk/content_types/emailTemplate) */
export type EmailTemplateReplyToArgs = {
  locale?: Maybe<Scalars['String']>;
};


/** A template to use for sending emails [See type definition](https://app.contentful.com/spaces/toxox86i0ilk/content_types/emailTemplate) */
export type EmailTemplateSubjectArgs = {
  locale?: Maybe<Scalars['String']>;
};


/** A template to use for sending emails [See type definition](https://app.contentful.com/spaces/toxox86i0ilk/content_types/emailTemplate) */
export type EmailTemplateBodyArgs = {
  locale?: Maybe<Scalars['String']>;
};
...
export type EmailTemplateFilter = {
  ...
  replyTo_not_in?: Maybe<Array<Maybe<Scalars['String']>>>;
...
export enum EmailTemplateOrder {
  ...
  FromAsc = 'from_ASC',
  FromDesc = 'from_DESC',
  ReplyToAsc = 'replyTo_ASC',
  ReplyToDesc = 'replyTo_DESC',
...
export type GetEmailTemplatesQuery = (
  ...
  & { emailTemplateCollection?: Maybe<(
    ...
    & { items: Array<(
      { __typename?: 'EmailTemplate' }
      & Pick<EmailTemplate, 'id' | 'from' | 'replyTo' | 'subject' | 'body'>
    )> }
  )> }
);


export const GetEmailTemplatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetEmailTemplates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"emailTemplateCollection"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"from"}},{"kind":"Field","name":{"kind":"Name","value":"replyTo"}},{"kind":"Field","name":{"kind":"Name","value":"subject"}},{"kind":"Field","name":{"kind":"Name","value":"body"}}]}}]}}]}}]} as unknown as DocumentNode<GetEmailTemplatesQuery, GetEmailTemplatesQueryVariables>;