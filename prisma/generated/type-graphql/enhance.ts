...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "name", "bio", "url", "projects", "datasets"],
  UserOrderByInput: ["id", "name", "bio", "url", "datasets"],
  UserWhereUniqueInput: ["id", "name"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "bio", "url", "datasets"],
  ...
  UserCreateInput: ["id", "name", "bio", "url", "datasets", "projects"],
  UserUpdateInput: ["id", "name", "bio", "url", "datasets", "projects"],
  UserCreateManyInput: ["id", "name", "bio", "url", "datasets"],
  UserUpdateManyMutationInput: ["id", "name", "bio", "url", "datasets"],
  ...
  UserUpdateWithoutProjectsInput: ["id", "name", "bio", "url", "datasets"],
...
const outputsInfo = {
  ...
  UserCountAggregate: ["id", "name", "bio", "url", "datasets", "_all"],
  UserMinAggregate: ["id", "name", "bio", "url"],
  UserMaxAggregate: ["id", "name", "bio", "url"]
};
const argsInfo = {
